...
/**
 * Brand system — logomark + wordmark + combined logo. Mirrors the web
 * app's brand component so a single PNG swap propagates everywhere.
 *
 ...
 *
 * Wordmark renders 'Superaccountant' with the aurora gradient — same
 * 6s fg → accent → fg shine loop as the marketing hero.
 */
