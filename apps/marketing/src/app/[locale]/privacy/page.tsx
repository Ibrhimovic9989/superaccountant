  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <strong>Profile data</strong> — phone, country, city, current role, employer, experience,
          exam goal, study hours, target exam date, and your free-text "why are you here" answer.
          You provide this during onboarding to personalize the tutor.
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          To <strong>personalize your experience</strong> — your profile fields are passed into the
          tutor's system prompt so it addresses you by name, calibrates explanations to your
      ...
      <p>
        We do not sell your data. We do not use your data to train third-party AI models. Your tutor
        messages are not used to train our own models without your explicit opt-in.
      </p>

      <h2>3. Who we share it with</h2>
      <p>
        We share data only with the service providers we need to operate. Each is bound by their own
        data processing agreement.
      </p>
      <ul>
        <li>
          <strong>Supabase</strong> (Singapore region) — primary database and authentication tokens.
          Stores all account, profile, learning, and tutor data.
        </li>
        <li>
          <strong>Microsoft Azure (OpenAI)</strong> — runs the language model that powers the tutor.
          Your messages are sent for completion. Microsoft does not retain them for training and
      ...
      <p>
        Most data is stored on Supabase servers in Singapore. Azure OpenAI inference happens in the
        East US region. Email is sent via Resend's US infrastructure. By using the Service, you
        consent to your data being processed in these locations.
      </p>
      ...
      <ul>
        ...
        <li>
          Learning data + certificates: until you delete your account, or 7 years, whichever is
          shorter.
        </li>
      ...
      <ul>
        ...
        <li>
          <strong>Delete</strong> — remove your account and all associated data. The delete button
          on the profile page does this immediately.
        </li>
        <li>
          <strong>Export</strong> — download a copy of your account, profile, and learning data as
          JSON. Email us to request this.
        </li>
        <li>
      ...
      <h2>8. Cookies</h2>
      <p>
        We use a small number of essential cookies — a session cookie to keep you logged in, a theme
        cookie to remember your dark/light preference, and a locale cookie to remember your
      ...
      <p>
        ...
        encrypted with TLS. Data at rest is encrypted by Supabase. Certificates are HMAC-signed to
        prevent tampering. We do not have access to your Google or email account.
      </p>

      <h2>10. Changes</h2>
      <p>
        We may update this policy as the Service evolves. Material changes will be announced via
        email at least 14 days in advance. The "last updated" date above always reflects the current
        version.
      </p>
...
function ArabicBody() {
  return (
    <>
      ...
      <ul>
        <li>
          <strong>بيانات الحساب</strong> — اسمك وبريدك الإلكتروني وصورة ملفك الشخصي (إذا سجلت عبر
          Google).
        </li>
        <li>
          <strong>بيانات الملف الشخصي</strong> — الهاتف، البلد، المدينة، الدور الحالي، جهة العمل،
          الخبرة، الهدف من الامتحان، ساعات الدراسة، تاريخ الامتحان المستهدف، وإجابتك النصية الحرة
          "لماذا أنت هنا".
        </li>
        <li>
          <strong>بيانات التعلم</strong> — إجابات اختبار التحديد، تقدمك في الدروس، محاولات التمارين،
          درجات الإتقان، الخطط اليومية، ونتائج الاختبار الكبير.
        </li>
        <li>
          <strong>رسائل المدرس</strong> — كل رسالة ترسلها للمدرس الذكي وكل رد يولّده.
        </li>
        <li>
          <strong>البيانات التشغيلية</strong> — عنوان IP، معلومات الجهاز، وسجلات الخادم الأساسية.
          تُستخدم لتصحيح الأخطاء ومنع إساءة الاستخدام.
        </li>
      </ul>
      <p>
      ...
      <ul>
        ...
        <li>
          لـ<strong>تخصيص تجربتك</strong> — تُمرَّر حقول ملفك الشخصي إلى تعليمات المدرس بحيث يخاطبك
          بالاسم، ويعاير الشروحات حسب مستوى خبرتك، ويحترم ميزانيتك الدراسية.
        </li>
      ...
      <h2>٤. أين تُخزَّن</h2>
      <p>
        معظم البيانات مخزنة على خوادم Supabase في سنغافورة. استدلال Azure OpenAI يحدث في منطقة شرق
        الولايات المتحدة. باستخدامك للخدمة، فإنك توافق على معالجة بياناتك في هذه المواقع.
      </p>
      ...
      <h2>٨. الكوكيز</h2>
      <p>
        نستخدم عدداً قليلاً من الكوكيز الأساسية — كوكي جلسة لإبقائك مسجلاً، كوكي للوضع الداكن، كوكي
        للغة. لا نستخدم كوكيز تتبع تابعة لجهات خارجية.
      </p>

      <h2>٩. الأمان</h2>
      <p>
        لا نخزن كلمات المرور — نستخدم روابط بريدية سحرية و Google OAuth. البيانات أثناء النقل مشفرة
        بـ TLS. البيانات الساكنة مشفرة بواسطة Supabase. الشهادات موقعة بـ HMAC لمنع التلاعب.
      </p>

      <h2>١٠. التغييرات</h2>
      <p>
        قد نحدّث هذه السياسة. سيتم الإعلان عن التغييرات الجوهرية عبر البريد الإلكتروني قبل ١٤ يوماً
        على الأقل.
      </p>

      <h2>١١. اتصل بنا</h2>
      <p>
        أسئلة أو طلبات؟ راسل <a href="mailto:info@superaccountant.in">info@superaccountant.in</a> أو
        اكتب إلى: شركة سوبر أكاونتنت تكنولوجيز، وحدة 422، الطابق الرابع، داون تاون مول، لاكديكابول،
        حيدر آباد، الهند.
      </p>
    </>
  )
