...
export default function SearchClient() {
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: doSearch is
  // declared inside this component and reads the same `locale` state,
  // so it's stable enough to omit from deps.
  React.useEffect(() => {
              ...
              {results.map((r, i) => (
                ...
                >
                  ...
                  >
                    ...
                    <h3 className="text-sm font-semibold text-fg sm:text-base">{r.lessonTitle}</h3>
                    {r.heading && (
