...
export type Song = {
  ...
  /** Reference to the tune being sung — for the "sung to the tune of …" line. */
  tune: {
    name: string
    /** YouTube video ID — kept as a reference, not rendered as embed. */
    youtubeId: string
  }
  /**
   * Public URL of the in-app sung MP3 (Supabase Storage `song-audio` bucket).
   * Generated by `scripts/generate-song-audio.mjs`. Optional so the page
   * gracefully degrades while audio is being generated.
   */
  audioUrl?: string
...
export const SONGS: Song[] = [
  // ── Song 1: TDS Sea Shanty ────────────────────────────────
  {
    ...
    audioUrl:
      'https://hksvuuuikecntossgkhp.supabase.co/storage/v1/object/public/song-audio/tds-sea-shanty/en.mp3',
    emoji: '⚓',
    color: 'accent',
    intro:
  ...
  // ── Song 2: Golden Rules of Accounting ────────────────────
  {
    ...
    tune: { name: 'The Wellerman (Nathan Evans, 2021)', youtubeId: '1IReY4IUKlw' },
    audioUrl:
      'https://hksvuuuikecntossgkhp.supabase.co/storage/v1/object/public/song-audio/golden-rules/en.mp3',
    emoji: '⚖️',
    color: 'warning',
    intro:
  ...
  // ── Song 3: IFRS / Ind AS Numbers Shanty ──────────────────
  {
    ...
    tune: { name: 'The Wellerman (Nathan Evans, 2021)', youtubeId: '1IReY4IUKlw' },
    audioUrl:
      'https://hksvuuuikecntossgkhp.supabase.co/storage/v1/object/public/song-audio/ifrs-numbers/en.mp3',
    emoji: '📘',
    color: 'success',
    intro:
